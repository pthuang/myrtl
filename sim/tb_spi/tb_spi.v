...
parameter   USER_CLK_RATE   =  32'd122_880_000  ; // Default: 122.88 MHz
parameter   SPI_CLK_RATE    =  32'd1_920_000    ; // Default: 1.92   MHz
...
begin
    ...
    always@(negedge clk) begin
        ...
        begin
            ...
            end else if(cnt0 == TB_CNT_MAX) begin
                cnt0        <=  0;
                flag0       <=  ~flag0;
                i_rd_evt    <=  1;
                if(flag0) begin
    ...
    spi_master # (
        ...
        .I_WIDTH            ( SPI_DATA_WIDTH    ), // 
        .O_WIDTH            ( SPI_DATA_WIDTH    )  // 
    ) spi_master (
        .user_clk           ( clk               ), // 
        .user_rst           ( rst               ), // 
