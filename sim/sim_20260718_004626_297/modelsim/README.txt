...
#
# Generated by export_simulation on Sat Jul 18 00:48:14 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './tb_arbitor.sh' script.

./tb_arbitor.sh -reset_run
...
./tb_arbitor.sh -noclean_files

For more information on the script, please type './tb_arbitor.sh -help'.
